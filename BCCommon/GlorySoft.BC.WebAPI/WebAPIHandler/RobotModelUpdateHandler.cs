...
{
    public class RobotModelUpdateHandler : AbstractWebAPIMessageHandlercs
    {
        public WebSocketMessage Execute(string userName, string clientip, string type, bc_robot_model data)
        {
            ...
            try
            {
                ...
                switch (type)
                {
                    case "RobotModelAdd":
                        {
                            dbService.Insertbc_robot_model(data);
                        }
                        break;
                    case "RobotModelUpdate":
                        {
                            dbService.Updatebc_robot_model(data);
                        }
                        break;
                    default:
                        break;
