...
{
    public class EQPProfileItemUpdateHandler : AbstractWebAPIMessageHandlercs
    {
        public WebSocketMessage Execute(string userName, string clientip, string type, cfg_eqpprofile_item data)
        {
            ...
            try
            {
                ...
                switch (type)
                {
                    case "EQPProfileItemAdd":
                        {
                            dbService.Insertcfg_eqpprofile_item(data);
                        }
                        break;
                    case "EQPProfileItemUpdate":
                        {
                            dbService.Updatecfg_eqpprofile_item(data);
                        }
                        break;
                    default:
                        break;
