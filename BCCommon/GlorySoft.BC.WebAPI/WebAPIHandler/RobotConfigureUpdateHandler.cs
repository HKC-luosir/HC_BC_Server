...
{
    public class RobotConfigureUpdateHandler : AbstractWebAPIMessageHandlercs
    {
        public WebSocketMessage Execute(string userName, string clientip, string type, bc_robot_configure data)
        {
            ...
            try
            {
                ...
                switch (type)
                {
                    case "RobotConfigureAdd":
                        {
                            dbService.Insertbc_robot_configure(data);
                        }
                        break;
                    case "RobotConfigureUpdate":
                        {
                            dbService.Updatebc_robot_configure(data);
                        }
                        break;
                    default:
                        break;
