...
{
    public class DeleteProcessEndGlassData : AbstractWebAPIMessageHandlercs
    {
        public WebSocketMessage Execute(string userName, string clientip, Dictionary<string, object> InitData)
        {
            ...
            try
            {
                ...
                {
                    messageName = "deleteProcessEndGlassData",
                ...
                dbService.Deletewip_processend_glass(serData);
            ...
            opiHis.Add("operating", "进行了ProcessEndGlass数据删除操作！");
