...
namespace Glorysoft.BC.EIP.Handlers
{
    ...
    public class MaterialValidationRequestBlockHandler : AbstractEventHandler
    {
        public MaterialValidationRequestBlockHandler(IPLCContext context)
           : base(context)
        {
        }
        ...
        public override void Execute(PLCEventArgs args)
        {
            try
            {
                ...
                logicService.MaterialValidationRequest(oEQP, MaterialStatus, MaterialID, MaterialType, UnitNumber, SlotNumber, MaterialCount, UnloadingCode, i, txid);
            }
            catch (Exception ex)
            {
